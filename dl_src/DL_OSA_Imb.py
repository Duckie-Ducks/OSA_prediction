...
def load_OSA(args):
    ...
    test_ids = list(np.random.choice(notnull_indices, n_test))
    train_ids = list(set(indices) - set(test_ids))
    print(len(test_ids))
    print(len(train_ids))
    '''
    ...
    return df, cat_cols, cont_cols, args.target_col, test_ids, train_ids
...
print(args)
data, cat_col_names, num_col_names, target_col, test_ids, train_ids = load_OSA(args)
