...
def feature_selection(model_name, target_col, balance_strategy, features_name):
    result_path = os.path.join('../results', target_col, model_name, model_name+'_'+balance_strategy+'_'+features_name+'.csv')
    pred_path = os.path.join('../results', target_col, model_name, model_name+'_'+balance_strategy+'_'+features_name+'_pred.xlsx')
